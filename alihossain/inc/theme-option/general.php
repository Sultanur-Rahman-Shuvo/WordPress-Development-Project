    ...
    <div class="main_area_option">
      ...
      echo "<p>Add your <strong>Header Area</strong> Information here.</p>"; ?>
        ...
        <form action="options.php" method="post">
            ...
            <input type="text" name="address-info" value="<?php echo get_option('address-info'); ?>"
                placeholder="Enter Your Address">

            <label for="email-info" name="email-info">Email Info</label>
            <input type="text" name="email-info" value="<?php echo get_option('email-info'); ?>"
                placeholder="Enter Your Email Address">

            <label for="phone-number" name="phone-number">Phone Number</label>
            <input type="text" name="phone-number" value="<?php echo get_option('phone-number'); ?>"
                placeholder="Enter Your Address">
